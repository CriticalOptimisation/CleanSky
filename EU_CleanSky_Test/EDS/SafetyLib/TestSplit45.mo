...
model TestSplit45 "Loads in series - middle"
  ...
  EU_CleanSky.EDS.SafetyLib.Cap sink1(gender=EU_CleanSky.EDS.SafetyLib.Gender.male)
...
equation
  connect(split1.f2, link.p) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(sink.m, load2.minusF) annotation (Line(
      points={{60,40},{56,40},{56,40},{40,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(sink1.p, link.n) annotation (Line(
      points={{-10,-50},{-10,-35},{-10,-20},{-10,-20}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(split1.f1, load2.plusM) annotation (Line(
      points={{0,40},{20,40}},
      color={255,0,255},
      smooth=Smooth.None));
