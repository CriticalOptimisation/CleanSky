...
model TestMerge02 "Split high source to two loads."
  ...
  EU_CleanSky.EDS.SafetyLib.Cap sink1(gender=EU_CleanSky.EDS.SafetyLib.Gender.female)
    annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=-90,
        origin={-40,-30})));
...
equation
  connect(sourceP.m, merge1.f) annotation (Line(
      points={{-70,40},{-60,40}},
      color={255,0,255},
      smooth=Smooth.None));
  ...
  connect(merge1.m2, load2.plusF) annotation (Line(
      points={{-50,32},{-50,-1.77636e-015}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(load2.minusM, sink1.n) annotation (Line(
      points={{-50,-20},{-50,-40}},
      color={255,0,255},
      smooth=Smooth.None));
  annotation (
