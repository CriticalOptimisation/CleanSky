...
model TestSplit68 "Ground propagation"
  import EU_CleanSky.EDS.SafetyLib;

  EU_CleanSky.EDS.SafetyLib.Split split1
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  EU_CleanSky.EDS.SafetyLib.Link link1(useLeak=true) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={30,-10})));
  ...
  EU_CleanSky.EDS.SafetyLib.Link link3(useLeak=true)
    annotation (Placement(transformation(extent={{-20,30},{0,50}})));
equation
  connect(split1.f2, link1.p) annotation (Line(
      points={{30,32},{30,32},{30,0},{30,0}},
      color={255,0,255},
      smooth=Smooth.None));
  ...
  connect(expr.y, link1.leak) annotation (Line(
      points={{-79,20},{20,20},{20,-12},{26,-12}},
      color={255,0,255},
