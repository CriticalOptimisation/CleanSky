...
model AirProxy "Local proxy of a piped air circulation system"
  extends Aircraft.Icons.InputOutputProxy;
  parameter H nr
    "The number of the hydraulic connector to connect to in the connector array.";

  Interfaces.HydrPort port(redeclare package Medium = AirMedium) annotation (Placement(transformation(extent={{90,-10},
