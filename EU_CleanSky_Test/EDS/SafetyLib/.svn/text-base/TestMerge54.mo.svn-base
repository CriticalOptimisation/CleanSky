...
model TestMerge54 "Load in series - middle"
...
equation
  connect(merge1.m2, link3.minusF) annotation (Line(
      points={{-10,32},{-10,16},{-10,0},{-10,0}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(sink.m, link1.minusF) annotation (Line(
      points={{-80,40},{-76,40},{-76,40},{-60,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(link1.plusM, merge1.f) annotation (Line(
      points={{-40,40},{-20,40}},
      color={255,0,255},
      smooth=Smooth.None));
  ...
  connect(link2.p, source2.n) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(link3.plusM, source1.f) annotation (Line(
