...
model TestSplit35 "Split low / One load to two sinks"
...
equation
  connect(split1.f2, link2.p) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(sink.m, load.plusF) annotation (Line(
      points={{60,40},{40,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(split1.f1, load.minusM) annotation (Line(
      points={{0,40},{20,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(link2.n, sinkP.p) annotation (Line(
      points={{-10,-20},{-10,-60}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(link1.n, split1.m) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(link1.p, logicFlowPCap.f) annotation (Line(
      points={{-60,40},{-80,40}},
      color={255,0,255},
      smooth=Smooth.None));
  annotation (
