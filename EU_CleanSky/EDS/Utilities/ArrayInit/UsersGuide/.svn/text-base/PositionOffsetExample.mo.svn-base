within EU_CleanSky.EDS.Utilities.ArrayInit.UsersGuide;
...
&nbsp;&nbsp;&nbsp;&nbsp;<font style=\"color: #0000ff; \">redeclare&nbsp;record</font>&nbsp;<font style=\"color: #0000ff; \">extends&nbsp;</font>Source('hidden'=false)
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style=\"color: #0000ff; \">parameter&nbsp;</font><font style=\"color: #ff0000; \">Integer</font>&nbsp;offset&nbsp;<font style=\"color: #006400; \">&QUOT;position&nbsp;index&nbsp;offset&QUOT;</font>;
...
&nbsp;&nbsp;&nbsp;&nbsp;<font style=\"color: #0000ff; \">function</font>&nbsp;MyCtor&nbsp;<font style=\"color: #0000ff; \">extends&nbsp;</font>CtorSrcType
...
&nbsp;&nbsp;&nbsp;&nbsp;<font style=\"color: #0000ff; \">end&nbsp;</font>MyCtor;
...
&nbsp;&nbsp;<font style=\"color: #ff0000; \">MyModel</font>&nbsp;table1[3]=<font style=\"color: #ff0000; \">MyArrayInit.Init</font>(3,&nbsp;ctor=MyArrayInit.MyCtor,&nbsp;<font style=\"color: #ff0000; \">MyArrayInit.Source</font>(offset=0));
&nbsp;&nbsp;<font style=\"color: #ff0000; \">MyModel</font>&nbsp;table2[5]=<font style=\"color: #ff0000; \">MyArrayInit.Init</font>(5,&nbsp;ctor=MyArrayInit.MyCtor,&nbsp;<font style=\"color: #ff0000; \">MyArrayInit.Source</font>(offset=3));
