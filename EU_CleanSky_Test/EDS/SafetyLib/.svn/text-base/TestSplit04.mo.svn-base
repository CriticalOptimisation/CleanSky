...
model TestSplit04 "Split high source to two loads."
...
equation
  connect(sink1.m, link.f) annotation (Line(
      points={{-10,-40},{-10,-35},{-10,-35},{-10,-30},{-10,-20},{-10,-20}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(link.m, split1.f2) annotation (Line(
      points={{-10,0},{-10,16},{-10,16},{-10,32}},
      color={255,0,255},
      smooth=Smooth.None));
