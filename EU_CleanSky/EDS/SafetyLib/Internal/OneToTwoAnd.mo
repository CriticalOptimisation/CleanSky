...
model OneToTwoAnd "Each boolean output is true if both other inputs are true"
  extends OneToTwo;
  ...
  Modelica.Blocks.Logical.Pre pre2 annotation (Placement(transformation(
        ...
        origin={-4,-30})));
equation
  connect(and3.y, m.MtoF) annotation (Line(
      points={{-48.8,0},{-100,0}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(and2.y, f2.FtoM) annotation (Line(
      points={{48.8,40},{100,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(and1.y, f1.FtoM) annotation (Line(
      points={{48.8,-40},{100,-40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(and2.u1, m.FtoM) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(and1.u1, m.FtoM) annotation (Line(
      points={{30.4,-40},{-60,-40},{-60,0},{-100,0}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(and3.u1, f2.MtoF) annotation (Line(
      points={{-30.4,0},{60,0},{60,40},{100,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(and3.u2, f1.MtoF) annotation (Line(
