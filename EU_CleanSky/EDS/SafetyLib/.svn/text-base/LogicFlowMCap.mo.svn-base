...
model LogicFlowMCap "This component can terminate a link by a plug"
...
initial equation
  ...
  pre(highF.MtoF)=false;
  pre(groundF.MtoF)=false;
  pre(lowF.MtoF)=false;

equation
  problem = f.open.FtoM or f.leak.FtoM;
  ...
  connect(revF,f. reverse) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(booleanExpression.y,revF. FtoM) annotation (Line(
      points={{61,40},{70,40},{70,20},{80,20}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(booleanExpression.y,leakF. FtoM) annotation (Line(
      points={{61,40},{70,40},{70,60},{80,60}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre1.y,highF. FtoM) annotation (Line(
      points={{56.6,-20},{80,-20}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre1.u,highF. MtoF) annotation (Line(
      points={{42.8,-20},{40,-20},{40,0},{80,0},{80,-20}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre2.u,groundF. MtoF) annotation (Line(
      points={{42.8,-60},{40,-60},{40,-40},{80,-40},{80,-60}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre3.u,lowF. MtoF) annotation (Line(
      points={{42.8,-100},{40,-100},{40,-80},{80,-80},{80,-100}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre3.y,lowF. FtoM) annotation (Line(
      points={{56.6,-100},{80,-100}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre2.y,groundF. FtoM) annotation (Line(
      points={{56.6,-60},{80,-60}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(booleanExpression1.y,openF. FtoM) annotation (Line(
      points={{61,100},{80,100}},
      color={255,0,255},
      smooth=Smooth.None));
  annotation (defaultComponentName="cap",Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,
            -100},{100,100}},
        initialScale=0.04),
                   graphics={Polygon(
