...
model TestControlledPower1 "Test of controlled power supply switched on."
...
equation
  ...
  connect(power.f, load.minusF) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(leakSrc.y, power.u) annotation (Line(
      points={{-63,-18},{-30,-18},{-30,52},{-50,52},{-50,70},{-40,70}},
      color={255,0,255},
      smooth=Smooth.None));
  annotation (
    Diagram(graphics),
