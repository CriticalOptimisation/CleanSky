...
model TestLoad8 "Test of dipole circuits with fluid leak after the load"
...
<p>The leak in &QUOT;link2&QUOT; lets used fluid escape, but it has no effect on the operation of the load. The leak is signalled downstream, and after a while a tank may signal a low level.</p>
</html>"));
end TestLoad8;
