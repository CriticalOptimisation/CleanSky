...
model Normal "Normal distribution"
  extends ProbabilityDistribution.Icons.Distribution_Normal2;

  extends ProbabilityDistribution.Interfaces.PartialDistribution(
    final distributionName="Normal",
    final i_distribution=1,
...
source="modelica://ProbabilityDistribution/Images/NormalDistribution.png")),
