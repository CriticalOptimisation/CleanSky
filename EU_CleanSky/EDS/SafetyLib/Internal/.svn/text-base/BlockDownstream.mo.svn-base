...
model BlockDownstream
  "Prevents a logic true entering upstream from propagating downstream"
...
/* permanent connections */
  ...
  connect(and1.u1, f.MtoF) annotation (Line(
      ...
      pattern=LinePattern.None,
      smooth=Smooth.None));
  connect(reversed, and2.u2) annotation (Line(
      points={{-26,-100},{-26,-70},{15.2,-70},{15.2,-47.2}},
      color={255,0,255},
      pattern=LinePattern.None,
      smooth=Smooth.None));
  connect(not1.y, andN.u2) annotation (Line(
      points={{-73.4,-60},{35.2,-60},{35.2,-47.2}},
      color={255,0,255},
      pattern=LinePattern.None,
      smooth=Smooth.None));
  connect(and1.u2, not1.y) annotation (Line(
      points={{-24.8,-27.2},{-24.8,-60},{-73.4,-60}},
      color={255,0,255},
      pattern=LinePattern.None,
      smooth=Smooth.None));
  connect(andP.u2, reversed) annotation (Line(
      points={{-44.8,-27.2},{-44.8,-70},{-26,-70},{-26,-100}},
      color={255,0,255},
      pattern=LinePattern.None,
      smooth=Smooth.None));
  annotation (defaultComponentName="blkDown",Icon(graphics={
        Polygon(
