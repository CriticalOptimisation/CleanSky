...
model TestFailureMode1
  "Test that failure mode delivers false without interaction nor initial failure."
  import EU_CleanSky.EDS.SafetyLib;

  EU_CleanSky.EDS.SafetyLib.FailureMode failureMode(redeclare model Law =
        ProbabilityDistribution.Continuous.Exponential, lambda=0)
