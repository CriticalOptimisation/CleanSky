...
model TestSplit16 "Split high / Power one load from two sources."
...
equation
  connect(logicFlowPCap.f, load.m) annotation (Line(
      points={{-80,40},{-60,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(load.f, split1.m) annotation (Line(
      points={{-40,40},{-20,40}},
      color={255,0,255},
      smooth=Smooth.None));
  ...
  connect(link2.f, sink.m) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(split1.f2, link1.m) annotation (Line(
      points={{-10,32},{-10,0}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(link1.f, sinkP.m) annotation (Line(
      points={{-10,-20},{-10,-40}},
      color={255,0,255},
      smooth=Smooth.None));
  annotation (
