...
model TestSplit57 "Loads in series - middle"
...
equation
  connect(split1.f2, load2.plusM) annotation (Line(
      points={{-10,32},{-10,16},{-10,0},{-10,0}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(sink.m, load1.plusF) annotation (Line(
      points={{60,40},{40,40}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(sink1.m, load2.minusF) annotation (Line(
  ...
  connect(link.n, split1.m) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(link.p, sourceP.n) annotation (Line(
      points={{-60,40},{-80,40}},
      color={255,0,255},
      smooth=Smooth.None));
  annotation (
