...
model ReversibleShapedDipole
  "Implements interface reversibility for bipolar sources and loads."
  ...
  parameter Boolean useSourceShape=false
    "If true, the shape us changed to a box, and + defaults to the female connector."
    annotation (Dialog(group="Connections"),Evaluate=true, HideResult=true);
