...
model TestLopot3
  "Test of low potential source/sink with fluid leak and colors."
  ...
  EU_CleanSky.EDS.SafetyLib.Sources.HiPotential sourceP(semantics=EU_CleanSky.EDS.SafetyLib.Semantics.fluid)
    annotation (Placement(transformation(extent={{-90,30},{-70,50}})));
  Modelica.Blocks.Sources.BooleanConstant leak(k=true)
    annotation (Placement(transformation(extent={{-84,-28},{-64,-8}})));
  EU_CleanSky.EDS.SafetyLib.Sources.LoPotential sink(semantics=EU_CleanSky.EDS.SafetyLib.Semantics.fluid)
