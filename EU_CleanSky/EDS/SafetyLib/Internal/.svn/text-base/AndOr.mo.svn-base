...
model AndOr "Logical combination: y = (pre(input) and u2) or u3"
  ...
  Modelica.Blocks.Interfaces.BooleanInput u1 annotation (Placement(
        transformation(extent={{140,60},{100,100}}), iconTransformation(
          extent={{140,46},{100,86}})));
  Modelica.Blocks.Interfaces.BooleanOutput y annotation (Placement(
        transformation(extent={{100,-102},{144,-58}}), iconTransformation(
...
equation
  ...
  connect(u3, or1.u2) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
  connect(pre1.u, u1) annotation (Line(
      points={{-32,12},{-32,60},{58,60},{58,80},{120,80}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(or1.y, y) annotation (Line(
      points={{71,0},{80,0},{80,-80},{122,-80}},
      color={255,0,255},
      smooth=Smooth.None));
